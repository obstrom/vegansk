            ...
            <Modal className={"rating-modal"} show={show} onHide={handleClose}>
                ...
                <Modal.Body className={"rating-modal-body"}>
                    <form className="rating-form">
                        ...
                        <input id="name-input" placeholder="Ditt namn..." name="name" className="review-input"></input>
                        <p className="disclaimer">Dina svar hanteras anonymt, lämna inga personuppgifter. Vänligen kommentera endast på produkten. <br/>Tack!</p>
                        <div>
