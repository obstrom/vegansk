        ...
        this.get("/products", () => [
            {
                ...
                about: "Bregott® Normalsaltat är en favorit på svenska smörgåsar alltsedan 1969." +
            ...
            },
            {
                ...
                ingredients: ["Vegetabilisk olja (raps 60%, palm#)", " vatten, salt (1,3%)", {specialId: 1}, "naturlig arom", " vinäger", " A- och D2 vitamin.",],
                about: "Flora 100% Växtbaserad är ett bredbart alternativ till smör med den goda smaken av Flora. " +
            ...
            },
            {
                ...
                ingredients: ["vatten", "vegetabiliska oljor (raps (17%), palm (14%), shea (8%))", "KÄRNMJÖLK (5%)", "modifierad stärkelse", "salt (1,5%)", {specialId: 1},
                    " syra (mjölksyra)", "naturlig arom", "vitamin A och D"],
                about: "Lätta Original är ett bredbart margarin med låg (39%) fetthalt. " +
            ...
            },
            {
                ...
                ingredients: ["Vatten", "vegetabilisk olja (solros 18%, linfrö 8%, raps 4%, palm#)", "" +
            ...
            },
            {
                ...
                ingredients: ["rapsolja (39%)", "vatten", "kokosolja (22%)", "sheaolja (13%)", "MANDELPASTA (2%)", "salt", {specialId: 1}
                    , " morotsjuice", "citronjuice", "naturlig arom", "vitamin A &D (vegetabilsk)."],

                about: "Naturli's Bredbart är ett vegansk och ekologisk \"smör\". Passar perfekt till frukostmackorna " +
                ...
                allergens: "Kan innehålla spår av: Jordnötter, hasselnötter, cashewnötter och pistaschnötter.",
                vegan: true,
            },
            {
                id: 6,
                ...
                ingredients: ["Solrosolja 40%","vatten","kokosolja 22%","sheasmör 13%","salt 0,9%",{specialId: 1},"juice (morot, citron)","arom","vitamin A","vitamin D."],
                about: "Ekologiskt Vegogott är ett veganskt och njutbart alternativ till smör. Tillverkat på solrosolja, kokosolja och sheasmör är det bredbart och läckert att äta på mackan!",
                allergens: "",
                vegan: true,
            },
        ]);
        ...
        this.get("/special-ingredients", () => [
            {
                ...
                text: "Emulgeringsmedel kan användas för att underlätta tillverkningen av vissa livsmedel " +
            ...
            },
            {
                id: 2,
                name: "kaliumklorid",
                text: "Kaliumklorid, är ett ämne som kristalliserar i kubiska kristaller. " +
